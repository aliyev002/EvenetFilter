let goods = [
  ...
  function filterByStore(storeName) {
    ...
    const filteredGoods = goods.filter(item => item.store_name === storeName);
    filteredGoods.forEach(product => {
      ...
      productItem.innerHTML = `
        ...
        <p><strong>Qiymət:</strong> ${product.product_price} AZN</p>
        <p><strong>Ünvan:</strong> ${product.store_address}</p>
      `;
